...
export const projectDemos: ProjectDemo[] = [
  {
    ...
    summary:
      'Type a symptom and get a dynamic diagnosis with ranked causes, early outcome preview, and business impact - a mobile ops prototype tested with store managers before platform investment.',
    challenge:
  ...
  },
  {
    ...
    approach:
      'We built three guided journeys inside a working prototype: feedback analysis, executive brief generation, and practice group review - each ending with measurable outcomes.',
    outcome:
