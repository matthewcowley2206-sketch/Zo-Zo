...
import { StrategyClarityDemo } from './strategy/StrategyClarityDemo'
import { Button } from '../ui/Button'
import { FadeIn } from '../ui/FadeIn'
import { Section, SectionHeader } from '../ui/Section'
import { ServiceCardLink } from './ServiceCardLink'

type StrategyDirectionContentProps = {
  service: Service
}

export function StrategyDirectionContent({ service }: StrategyDirectionContentProps) {
  const related = getRelatedServices(service.slug)
  const imagery = serviceImagery.strategy
    ...
    <>
      ...
      <Section>
        <FadeIn className="content-wide">
          <StrategyClarityDemo />
          <p className="mx-auto mt-5 max-w-[620px] text-center text-[0.8125rem] leading-relaxed text-muted-light">
            Drag all nine stickies to see a sample choice cascade and 8-slide pack. In a real engagement,
            this is shaped with your team, your numbers, and your board - not generated from a template alone.
          </p>
        </FadeIn>
      </Section>
      ...
      <Section theme="cream">
        <SectionHeader
          ...
          description="Some clients need a single clarity session. Others want a scoped project. We figure out what fits together."
        />
